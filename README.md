...
| `homepage`       | `homepage`       | `ghcr.io/gethomepage/homepage`          | `ghcr.io/gethomepage/homepage:v1.12.2`               |
...
| `zeroclaw-cyrus` | `zeroclaw`       | `ghcr.io/ccamel/zeroclaw-runtime`       | `ghcr.io/ccamel/zeroclaw-runtime:v0.8.4-ubuntu24.04` |
| `zeroclaw-lior`  | `zeroclaw`       | `ghcr.io/ccamel/zeroclaw-runtime`       | `ghcr.io/ccamel/zeroclaw-runtime:v0.8.4-ubuntu24.04` |
...
| `zeroclaw-runtime` | `v0.8.0-ubuntu24.04` | `linux/amd64`                          | [`ghcr.io/ccamel/zeroclaw-runtime:v0.8.0-ubuntu24.04`](https://github.com/ccamel/terraforming-chez-moi/pkgs/container/zeroclaw-runtime) | [`docker/zeroclaw-runtime/v0.8.0-ubuntu24.04/Dockerfile`](docker/zeroclaw-runtime/v0.8.0-ubuntu24.04/Dockerfile) |
| `zeroclaw-runtime` | `v0.8.4-ubuntu24.04` | `linux/amd64`                          | [`ghcr.io/ccamel/zeroclaw-runtime:v0.8.4-ubuntu24.04`](https://github.com/ccamel/terraforming-chez-moi/pkgs/container/zeroclaw-runtime) | [`docker/zeroclaw-runtime/v0.8.4-ubuntu24.04/Dockerfile`](docker/zeroclaw-runtime/v0.8.4-ubuntu24.04/Dockerfile) |
...
| <a name="input_home_assistant_url"></a> [home_assistant_url](#input_home_assistant_url)                                                    | Browser-visible URL for Home Assistant, without a trailing slash                   | `string` | n/a                                                    |   yes    |
